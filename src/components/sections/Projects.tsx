        ...
        <div className="mb-14 grid gap-6 md:grid-cols-2">
          {featured.map((project, i) => (
            <motion.div
              ...
              className="group border-border bg-card card-hover flex flex-col gap-4 rounded-2xl border p-7 transition-all hover:border-primary/30"
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {others.map((project, i) => (
                <motion.div
                  ...
                  className="group border-border bg-card card-hover flex flex-col gap-3 rounded-xl border p-5 transition-all hover:border-primary/30"
