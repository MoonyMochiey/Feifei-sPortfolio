          ...
          {featured.map((project, i) => {
            ...
            return (
              <motion.div
                ...
                className="group border-border bg-card card-hover flex flex-col gap-4 rounded-2xl border p-7 cursor-pointer transition-all hover:border-primary/30"
              ...
              {others.map((project, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group border-border bg-card card-hover flex flex-col gap-3 rounded-xl border p-5 cursor-pointer transition-all hover:border-primary/30"
